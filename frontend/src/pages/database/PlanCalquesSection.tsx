...
type CalqueFormData = { nom: string; description: string; is_downloadable: boolean; type: string; niveau_accreditation: number; zoom_min: number | null; zoom_max: number | null; icone_path: string | null; icone_size: number; couleur: string; template_champs: Record<string, unknown> | null; owner_id: string | null };
